...
public class FloatLastAggregatorFactory extends AggregatorFactory
{
  ...
  public Aggregator factorize(ColumnSelectorFactory metricFactory)
  {
    ...
    return nullHandlingConfig.getNullableAggregator(new FloatLastAggregator(
        name,
  ...
  {
    FloatColumnSelector floatColumnSelector = metricFactory.makeFloatColumnSelector(fieldName);
    return nullHandlingConfig.getNullableAggregator(new FloatLastBufferAggregator(
        metricFactory.makeLongColumnSelector(Column.TIME_COLUMN_NAME),
        floatColumnSelector
    ), floatColumnSelector);
  }
  ...
  {
    return new FloatLastAggregatorFactory(name, name, nullHandlingConfig)
    {
      @Override
      public Aggregator factorize(ColumnSelectorFactory metricFactory)
      {
        final ObjectColumnSelector selector = metricFactory.makeObjectColumnSelector(name);
        return nullHandlingConfig.getNullableAggregator(new FloatLastAggregator(name, null, null)
        {
          @Override
      ...
      {
        final ObjectColumnSelector selector = metricFactory.makeObjectColumnSelector(name);
        return nullHandlingConfig.getNullableAggregator(new FloatLastBufferAggregator(null, null)
        {
          @Override
