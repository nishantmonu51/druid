...
public class NullFilteringBufferAggregator implements BufferAggregator
{
  private final BufferAggregator delegate;
  private final ColumnValueSelector selector;


  public NullFilteringBufferAggregator(BufferAggregator delegate, ColumnValueSelector selector)
  {
