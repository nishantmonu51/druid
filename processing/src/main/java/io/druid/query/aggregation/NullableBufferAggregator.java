...
public class NullableBufferAggregator implements BufferAggregator
{
  ...
  public void init(ByteBuffer buf, int position)
  {
    ...
    delegate.init(buf, position + Byte.SIZE);
  }
  ...
  {
    return delegate.get(buf, position + Byte.SIZE);
  }

  @Override
  public float getFloat(ByteBuffer buf, int position)
  {
    return delegate.getFloat(buf, position + Byte.SIZE);
  }

  @Override
  public long getLong(ByteBuffer buf, int position)
  {
    return delegate.getLong(buf, position + Byte.SIZE);
  }
